    ...
    <script src="<c:url value="/static/js/calendar/fullcalendar.js" />"></script>
    <!-- End -->
	...
	<!-- Select Box -->
	<script type="text/javascript" src="<c:url value="/static/js/selectBox/jquery.selectBox.js" />"></script>
