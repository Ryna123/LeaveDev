	...
	$.jstree.core.prototype = {
		...
		init : function (el, options) {
			...
			this._data.core.original_container_html
				...
				.remove();
			this.element.html("<"+"ul class='jstree-container-ul jstree-children' role='group'><"+"li id='j"+this._id+"_loading' class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='tree-item'><i class='jstree-icon jstree-ocl'></i><i class='jstree-icon'></i><"+"li class='jstree-anchor' href='#'>" + this.get_string("Loading ...") + "</li></li></ul>");
		...
		refresh : function (skip_loading, forget_state) {
			...
			if(!skip_loading) {
				this.element.html("<"+"ul class='"+c+"' role='group'><"+"li class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='treeitem' id='j"+this._id+"_loading'><i class='jstree-icon jstree-themeicon-hidden'></i><i class='jstree-icon jstree-themeicon-hidden'></i><"+"li class='jstree-anchor' href='#'>" + this.get_string("Loading ...") + "</li></li></ul>");
