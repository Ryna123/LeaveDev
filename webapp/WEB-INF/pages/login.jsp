...
<html lang="en">
	<head>
		...
		<!-- text fonts -->
		<link rel="stylesheet" href="<c:url value="/static/fonts/fonts.googleapis.com.css" />" />
		...
		<!--[if lt IE 9]>
		<script src="<c:url value="/static/html5shiv.min.js" />"></script>
	...
	<body class="login-layout">
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue" id="id-company-text">&copy; Leave Management System</h4>
							</div>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="ssoId" class="form-control" placeholder="Username" />
													...
													<div class="clearfix">
														...
														<span class="width-35 pull-right">
															<input type="submit" class="bigger-110 btn btn-small  btn-primary " value="Log in">
														</span>
													</div>
										...
										<div class="widget-main">
											...
											<form>
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="inputPassword2" type="password" class="form-control" placeholder="Repeat password" />
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='<c:url value='/static/js/jquery.min.js' />' >"+"<"+"/script>");
		</script>
