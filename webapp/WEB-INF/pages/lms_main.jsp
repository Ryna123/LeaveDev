                                   ...
                                   <div class="row">
                                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                          <a href="<c:url value="/users/lms_adm_001" />">
                                            <div class="tile-stats" style="height: 138px;text-align: center;">
                                                <div class="icon" style="right: 163px;"><i class="fa fa-bar-chart"></i>
                                                </div>
                                        ...
                                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                           <a href="<c:url value="/users/lms_adm_002" />">
                                            <div class="tile-stats" style="height: 138px;text-align: center;">
                                                <div class="icon" style="right: 163px;"><i class="fa fa-list"></i>
                                                </div>
                                        ...
                                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                         <a href="<c:url value="/users/lms_adm_027" />">
                                            <div class="tile-stats" style="height: 138px;text-align: center;">
                                                <div class="icon" style="right: 163px;"><i class="fa fa-pencil-square-o"></i>
                                                </div>
                                ...
                                <div class="x_content">
                                   <div class="row">
                                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                            ...
                                            <div class="tile-stats" style="height: 138px;text-align: center;">
                                                <div class="icon" style="right: 163px;"><i class="fa fa-envelope-o"></i>
                                                </div>
                                        ...
                                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                          <a href="<c:url value="/admin/lms_adm_005" />">
                                            <div class="tile-stats" style="height: 138px;text-align: center;">
                                                <div class="icon" style="right: 163px;"><i class="fa fa-clock-o"></i>
                                                </div>
